...
class URLUpdateReferences(TestCase):
    ...
    def testUpdateReferences(self):
        ...
        why3_result = [
            "temp-fid-00b89c9a09c892158ca441b370c718b7",
            "temp-fid-00b89c9a09c892158ca441b370c718b9",
        ]
    ...
    def testNoDuplicatedReferences(self):
        ...
        assert (
            all([url in why2_result for url in why2["references"]]) and len(why2) == 1
        )
    ...
    def testUpdateReports(self):
        ...
        why3_result = [
            "00b89c9a09c892158ca441b370c718b7",
            "00b89c9a09c892158ca441b370c718b9",
        ]
