...
class Case(TimeStampedModel):
    ...
    description = models.TextField(
        null=True, blank=True, verbose_name="description_spa"
    )

    description_eng = models.TextField(
        null=True, blank=True, verbose_name="description_eng"
    )
    ...
    start_date_automatic = models.DateTimeField(null=True, blank=True)
    ...
    manual_is_active = models.BooleanField(default=False)
...
class Update(TimeStampedModel):
    TYPE = (("info", "Info"), ("grave", "Grave"), ("positivo", "Positivo"))
