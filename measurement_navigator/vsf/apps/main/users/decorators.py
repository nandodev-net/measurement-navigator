...
def analist_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/'):
    '''
...
def guest_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='/'):
    '''
