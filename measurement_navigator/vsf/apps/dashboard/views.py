    ...
    def _paginate(self, query_set: QuerySet) -> Page:
        ...
        try:
            ...
            raise AttributeError(
                '"page" GET request argument is not a valid number. Given: ', page
            )
        ...
        try:
            ...
            raise AttributeError(
                '"page_size" GET request argument is not a valid number. Given: ',
                page_size,
            )
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated and request.user.raw_pss:
            return HttpResponseRedirect(
                "/dashboard/users/createpass/" + str(request.user.id)
            )
        else:
